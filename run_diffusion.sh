...
if [ "$1" = "train" ]; then
    python scripts/diffusion.py --train_xml ./data/train/ --val_xml ./data/val/ --epochs 500 --batch_size 16 --num_workers 4 --obs_len 10 --pred_len 20 --num_polylines 500 --num_points 10 --max_agents 32 --lr 3e-4 --val_every 20 --model_type diffusion
elif [ "$1" = "eval" ]; then
