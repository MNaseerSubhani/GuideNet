        ...
        for i in range(1, N):
            ...
            for ego_id, transformed_agents in transformed_results.items():
                ...
                if self.save_plots:
                    ...
                    save_path = os.path.join(os.getcwd() + '/plots', f"{file_base}_ego_{ego_id}_seg_{i}_debug.png")
...
if __name__ == "__main__":
    ...
    for batch in dataloader:
        ...
        print(feature_tensors.shape, feature_masks.shape, polylines.shape, polyline_masks.shape, observed.shape, observed_masks.shape, ground_truth.shape, ground_truth_masks.shape, means.shape, stds.shape)
        break